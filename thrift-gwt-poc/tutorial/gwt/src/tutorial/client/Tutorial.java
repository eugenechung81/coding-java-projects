...
public class Tutorial implements EntryPoint {
	...
	public static void test1()
	{
		...
		expandNode("{\"children\": [{\"children\": null, \"name\": \"TEST 12\"}, {\"children\": null, \"name\": \"TEST 23\"}], \"name\": \"SECURITY (SECURITIES) LAUREATE EDUCATION INC BOND 20190901\"}");
	}

	static native void expandNode(String json)
	/*-{
		$wnd.expandNodeCallback(json)
	}-*/;
	...
	static native void exportMethods()
	/*-{
		$wnd.testNative = $entry(@tutorial.client.Tutorial::test1());
	}-*/;
